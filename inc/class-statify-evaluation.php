...
class Statify_Evaluation extends Statify {
	 ...
	 *
	 * @return int[] an array of integers (1, 2, ..., 31).
	 */
	public static function get_days( int $month = 1, int $year = 0 ): array {
		if ( 2 === $month ) {
	 ...
	 *
	 * @return int[] an array of integers (1, 2, ..., 12)
	 */
	 ...
	 */
	public static function get_daily_views( array $views_for_all_days, int $year, int $month, int $day ): int {
	 ...
	 */
	public static function get_monthly_views( array $views_for_all_months, int $year, int $month ): int {
		if ( $month < 1 || $month > 12 ) {
			return -1;
		}
	 ...
	 */
	public static function get_average_daily_views_of_month( array $views_for_all_months, int $year, int $month ): int {
		if ( $month < 1 || $month > 12 ) {
			return -1;
		}
	 ...
	 */
	public static function get_daily_views_of_month( array $views_for_all_days, int $year, int $month ): array {
		if ( $month < 1 || $month > 12 ) {
			return array();
		}
	 ...
	 */
	private static function is_current_month( int $year, int $month ): bool {
	 ...
	 */
	public static function get_yearly_views( array $views_for_all_years, int $year ): int {
	 ...
	 */
	public static function get_views_of_post( string $url, string $start = '', string $end = '' ): int {
		global $wpdb;
